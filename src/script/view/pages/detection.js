                ...
                <main class="container mx-auto px-4 py-8">
                    <div class="bg-white rounded-lg shadow p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Sign Language Reference Section -->
                            <div class="col-span-1 lg:col-span-2 bg-white rounded-lg shadow p-4 sm:p-6 mt-6">
                                <h2 class="text-xl font-bold text-[#013366] text-center mb-4">Referensi Bahasa Isyarat A - Z</h2>
                                <div class="w-full flex justify-center">
                                <img src="../img/abjad.svg" alt="Referensi Bahasa Isyarat A-Z"
